...
class HasOneThrough(BaseRelationship):
    ...
    def __get__(self, instance, owner):
        ...
        Arguments     instance (object|None): The instance we called.         If we didn't call the
        attribute and only accessed it then this will be None.     owner (object): The current model
    ...
    def get_related(
        ...
        """
        Get the data to hydrate the model for the distant table with Used when eager loading the
        model attribute.
