...
class HasManyThrough(BaseRelationship):
    ...
    def __get__(self, instance, owner):
        ...
        self.set_keys(
            self.distant_builder,
            self.intermediary_builder,
            attribute,
        )
        ...
        # Return QueryBuilder with proper join and where for method chaining
        ...
        return (
            ...
            .where(
                ...
                getattr(instance, self.local_owner_key),
            )
        )
    ...
    def register_related(self, key, model, collection):
        ...
        Arguments     key (str): The attribute name     model (Any): The model instance collection
        (Collection): The data for the related models
    ...
    def get_related(
        ...
        """
        Get a Collection to hydrate the models for the distant table with Used when eager loading
        the model attribute.

        Arguments     current_builder (QueryBuilder): The source models QueryBuilder object relation
        (HasManyThrough): this relationship object     eagers (Any):     callback (Any):

        Returns      Collection the collection of dicts to hydrate the distant models with
        """
