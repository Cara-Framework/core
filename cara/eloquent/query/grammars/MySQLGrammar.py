...
class MySQLGrammar(BaseGrammar):
    ...
    """
    Column strings are formats for how columns and key values should be formatted on specific
    queries. These can be different depending on the type of query.
