...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "STATUS_APPLIED": (".Operation", "STATUS_APPLIED"),
    "STATUS_FAILED": (".Operation", "STATUS_FAILED"),
    "STATUS_REVERSED": (".Operation", "STATUS_REVERSED"),
    ...
    "declared_foreign_keys": (".Objects", "declared_foreign_keys"),
    ...
    "missing_foreign_keys": (".Objects", "missing_foreign_keys"),
