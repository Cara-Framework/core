...
class BlockingCommandMixin(AutoReloadMixin, ABC):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.service_stats: dict[str, Any] = {"processed": 0, "failed": 0, "errors": []}
    ...
    def handle_blocking_command(self, **params):
        ...
        self.console.print(
            f"[bold #e5c07b]╭─ {self.get_command_name()} ─╮[/bold #e5c07b]"
        )
        self.console.print()
    ...
    def _show_service_status(self):
        ...
        self.console.print(
            f"[dim]Press Ctrl+C to stop {self.get_command_name().lower()}[/dim]"
        )
        self.console.print()
    ...
    def _show_final_stats(self):
        ...
        self.console.print()
        self.console.print(
            f"[bold #e5c07b]📊 Final {self.get_command_name()} Statistics:[/bold #e5c07b]"
        )
        ...
        if self.service_stats["processed"] > 0:
            success_rate = (
                (self.service_stats["processed"] - self.service_stats["failed"])
                / self.service_stats["processed"]
            ) * 100
    ...
    def increment_failed(self, error: str | None = None):
