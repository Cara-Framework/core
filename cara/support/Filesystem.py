"""
Filesystem Utilities for the Cara framework.

This module provides utility functions for file and directory operations, such as creation,
...
def creation_date(path_to_file):
    """Try to get the date that a file was created, falling back to when it was last modified if
    that isn't possible."""
...
def get_extension(filepath: str, without_dot=False) -> str:
    ...
    If without_dot=True the . prefix will be removed from the extension.
    """
