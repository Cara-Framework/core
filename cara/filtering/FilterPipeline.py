"""``FilterPipeline`` composition over a Cara QueryBuilder.
...
from cara.http import slice_page_with_lookahead
...
class _CachedPipeline:
    ...
    def count(self) -> int:
        ...
        return Cache.remember(
            self._build_key("count"), self._ttl, self._pipe.count, strict=False
        )
