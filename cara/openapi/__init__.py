...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "InvalidHeaderComponent": (".InvalidHeaderComponent", "InvalidHeaderComponent"),
    "MiddlewareHeaders": (".MiddlewareHeaders", "MiddlewareHeaders"),
    "OPT_TYPE": (".Inference", "OPT_TYPE"),
    "PASSTHROUGH_WRAPPERS": (".Inference", "PASSTHROUGH_WRAPPERS"),
    "RATE_LIMIT_HEADERS": (".RateLimitHeaders", "RATE_LIMIT_HEADERS"),
